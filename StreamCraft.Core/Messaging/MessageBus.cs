...
public class MessageBus<TMessageType> : IMessageBus<TMessageType> where TMessageType : Enum
{
    private readonly ConcurrentDictionary<TMessageType, ConcurrentDictionary<Guid, Delegate>> _subscriptions = new();
    private readonly object _publishLock = new();

    public void Publish<TPayload>(TMessageType messageType, TPayload payload)
    {
    ...
    public Guid Subscribe<TPayload>(TMessageType messageType, Action<TPayload> handler)
    {
