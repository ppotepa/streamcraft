        ...
        var host = new ApplicationHostBuilder()
            ...
            .ConfigureServices(services =>
            {
                ...
                if (eventSystemOptions.Enabled)
                {
                    ...
                    services.AddSingleton<ITriggerExpressionBuilder, TriggerExpressionBuilder>();
                    services.AddSingleton<ITriggerRuleCompiler, TriggerRuleCompiler>();
                    ...
                    services.AddSingleton<IEventTriggerFactory, TemplateTriggerFactory>();
                    services.AddSingleton<IEventSchemaProvider, DefaultEventSchemaProvider>();
                    services.AddSingleton<ITriggerTemplateCatalog, DefaultTriggerTemplateCatalog>();
                    services.AddSingleton<IEffectTemplateCatalog, DefaultEffectTemplateCatalog>();
