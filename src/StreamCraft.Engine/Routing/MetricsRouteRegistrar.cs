    ...
    private static void RegisterJsonMetrics(RouteRegistrarContext context)
    {
        ...
        app.MapGet(metricsRoute, async (HttpContext httpContext) =>
        {
            ...
            var payload = new
            {
                ...
                messageBus = messageBus is StreamCraft.Core.Messaging.IMessageBusDiagnostics busDiagnostics
                    ? new
                    {
                    ...
                    : null,
                scheduler = scheduler is StreamCraft.Core.Scheduling.ISchedulerDiagnostics schedulerDiag
                    ? new
                    {
