...
public class StreamCraftEngine : IEngineState
{
    ...
    private readonly StreamCraft.Core.Messaging.IMessageBus _sharedMessageBus;
    private readonly StreamCraft.Core.Bits.Templates.BitTemplateRegistry _templateRegistry;
    private readonly StreamCraft.Core.Bits.Templates.BitDefinitionStore _definitionStore;
    ...
    public StreamCraft.Core.Bits.Templates.BitTemplateRegistry TemplateRegistry => _templateRegistry;
    public StreamCraft.Core.Bits.Templates.BitDefinitionStore DefinitionStore => _definitionStore;
