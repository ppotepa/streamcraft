/**
 * Utility functions for reading and writing dock preferences
 */

import { DOCK_STORAGE_KEY, type DockPrefs } from "../types/dock.types";
...
export const writeDockPrefs = (prefs: DockPrefs): void => {
    ...
    try {
        window.localStorage.setItem(DOCK_STORAGE_KEY, JSON.stringify(prefs));
    } catch {
